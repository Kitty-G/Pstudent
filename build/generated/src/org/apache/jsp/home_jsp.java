...
//        session.setAttribute("user", "abcd");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<li><a href='/demo/2/about/' ><span>关于我们</span></a></li>\n");
      out.write("\n");
      out.write("\n");
      out.write("<li><a href='/demo/2/case/' ><span>案例展示</span></a></li>\n");
      out.write("\n");
      out.write("\n");
      out.write("<li><a href='/demo/2/demo/2/services/'  rel='dropmenu3'><span>服务范围</span></a></li>\n");
      out.write("\n");
      out.write("\n");
      out.write("<li><a href='/demo/2/demo/2/news/'  rel='dropmenu4'><span>新闻中心</span></a></li>\n");
      out.write("\n");
      out.write("\n");
      out.write("<li><a href='/Project/jsp/login.jsp' ><span>用户登录</span></a></li>\n");
      out.write("\n");
      out.write("\n");
      out.write("\t</ul>\n");
      out.write("\t</div>\n");
      ...
      out.write("<div class=\"lunhuan\">\n");
      out.write("    <div class=\"lunhuanback\">\n");
      out.write("        <p style=\"opacity: 1;filter:alpha(opacity=100);\"></p>\n");
      out.write("        <p></p>\n");
      out.write("    </div>\n");
      out.write("    <div class=\"lunhuan_main\">\n");
      out.write("        <div class=\"lunhuancenter\">\n");
      out.write("            <a href=\"javascript:void(0)\" class=\"centergif\"></a>\n");
      out.write("            <b class=\"slideUp\" style=\"background-image:url(/demo/2/templets/html5/images/lunhuan.png); background-repeat:no-repeat;opacity:1;filter:alpha(opacity=100); top:-10px;\"></b>\n");
      out.write("            <b class=\"slideUp\" style=\"background-image:url(/demo/2/templets/html5/images/lunhuan2.png); background-repeat:no-repeat;\"></b>\n");
      out.write("            <ul class=\"lunbonum\">\n");
      out.write("                <li class=\"lunboone\"></li>\n");
      out.write("                <li></li>\n");
      out.write("            </ul>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      ...
      out.write("\n");
      out.write("<!--banner js start-->\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("$(document).ready(function(){\n");
      out.write("    var ali=$('.lunbonum li');\n");
      out.write("    var aPage=$('.lunhuanback p');\n");
      out.write("    var aslide_img=$('.lunhuancenter b');\n");
      out.write("    var iNow=0;\n");
      out.write("    ali.each(function(index){\n");
      out.write("        $(this).mouseover(function(){\n");
      out.write("            slide(index);\n");
      out.write("        })\n");
      out.write("    });\n");
      out.write("    function slide(index){\n");
      out.write("        iNow=index;\n");
      out.write("        ali.eq(index).addClass('lunboone').siblings().removeClass();\n");
      out.write("\t\taPage.eq(index).siblings().stop().animate({opacity:0},600);\n");
      out.write("\t\taPage.eq(index).stop().animate({opacity:1},600);\n");
      out.write("        aslide_img.eq(index).stop().animate({opacity:1,top:-10},600).siblings('b').stop().animate({opacity:0,top:-40},600);\n");
      out.write("    }\n");
      out.write("\tfunction autoRun(){\n");
      out.write("        iNow++;\n");
      out.write("\t\tif(iNow==ali.length){\n");
      out.write("\t\t\tiNow=0;\n");
      out.write("\t\t}\n");
      out.write("\t\tslide(iNow);\n");
      out.write("\t}\n");
      out.write("\tvar timer=setInterval(autoRun,4000);\n");
      out.write("    ali.hover(function(){\n");
      out.write("\t\tclearInterval(timer);\n");
      out.write("\t},function(){\n");
      out.write("\t\ttimer=setInterval(autoRun,4000);\n");
      out.write("    });\n");
      out.write("})\n");
      out.write("</script>\n");
      out.write("<!--banner js end-->\n");
      out.write("\n");
      out.write("\n");
      out.write("</div>\n");
      out.write("\n");
